...
public class ImportData extends AppCompatActivity {
    ...
    private static final String JSON_OBJECT_REQUEST_URL = "http://192.168.1.7:4567/storages"; //Everyone change this ip address to the corresponding ip address of your emulator (ipconfig IPv4 address)
